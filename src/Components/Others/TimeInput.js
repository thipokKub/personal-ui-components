    ...
    render() {
        return (
            <input
                ...
                onFocus={(this.props.onFocus) ? (e) => this.props.onFocus(e) : undefined}
                onBlur={(this.props.onBlur) ? (e) => this.props.onBlur(e) : undefined}
                ref={(c) => {
                    this._input = c;
                    this.props.refFunc && this.props.refFunc(c);
                }}
            />
        );
    }
